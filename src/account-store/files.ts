...
export function assertRegularPrivateSourceFile(path: string): void {
  if (!existsSync(path)) {
...
export function writePrivateFileAtomically(path: string, content: string | Buffer): void {
...
export function acquirePoolLock(poolHome: string): () => void {
